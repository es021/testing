jQuery(document).ready(function () {
    ...
    function startExport(table, dismissCol)
    {
        ...
        jQuery.each(table.find("tr"), function (i, row) {
            ...
            jQuery.each(jQuery(row).find("td"), function (i, col) {
                ...
                if (typeof dismissCol !== "undefined") {
                    if (dismissCol.indexOf(i) <= -1) {
                        return true;
                    }
                }
        ...
        a.href = href;
        a.download = 'DISCHARGE DIFFERENT OPERATOR CODE (<?= $_POST["grp"] ?>).xls';
        a.click();
